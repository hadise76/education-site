...
const StuPanel = () => {
  ...
  return (
    ...
    <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
      <h2 className="text-2xl font-bold mb-6 text-center">پروفایل دانش‌آموز</h2>

      {message && (
        <p className={`text-center mb-4 ${message.includes("خطا") ? "text-red-500" : "text-[#e76a35]"}`}>
          {message}
        </p>
      )}
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label className="block text-right text-gray-700 text-sm font-bold mb-2" htmlFor="firstName">
            نام
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-right text-gray-700 text-sm font-bold mb-2" htmlFor="lastName">
            نام خانوادگی
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-right text-gray-700 text-sm font-bold mb-2" htmlFor="grade">
            پایه تحصیلی
          </label>
          <input
            type="text"
        ...
        <div className="mb-6">
          <label className="block text-right text-gray-700 text-sm font-bold mb-2" htmlFor="address">
            آدرس
          </label>
          <input
            type="text"
